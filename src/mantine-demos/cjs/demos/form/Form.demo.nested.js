...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    label: "First name",
    placeholder: "First name"
  }, form$1.getInputProps("user.firstName"))), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    label: "Last name",
    placeholder: "Last name",
    mt: "md"
  }, form$1.getInputProps("user.lastName"))), /* @__PURE__ */ React__default.createElement(core.Checkbox, __spreadValues({
    label: "I accepts terms & conditions",
    mt: "sm"
  }, form$1.getInputProps("terms", { type: "checkbox" }))), /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "sm",
    weight: 500,
    mt: "xl"
