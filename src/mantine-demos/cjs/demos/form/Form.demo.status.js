...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    maw: 400,
    mx: "auto"
  }, /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadProps(__spreadValues({}, form$1.getInputProps("text")), {
    label: "Touched/dirty demo",
    placeholder: "Touched/dirty demo"
  })), /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "sm",
    mt: "sm"
  }, "Touched:", " ", /* @__PURE__ */ React__default.createElement(core.Text, {
    span: true,
    color: form$1.isTouched("text") ? "blue" : "red"
  }, form$1.isTouched("text") ? "touched" : "not touched")), /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "sm"
  }, "Dirty:", " ", /* @__PURE__ */ React__default.createElement(core.Text, {
    span: true,
    color: form$1.isDirty("text") ? "blue" : "red"
  }, form$1.isDirty("text") ? "dirty" : "not dirty")));
}
const status = {
  type: "demo",
  component: Demo,
