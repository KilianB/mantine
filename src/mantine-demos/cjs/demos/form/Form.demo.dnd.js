...
function Demo() {
  ...
  const fields = form$1.values.employees.map((_, index) => /* @__PURE__ */ React__default.createElement(reactBeautifulDnd.Draggable, {
    key: index,
    index,
    draggableId: index.toString()
  }, (provided) => /* @__PURE__ */ React__default.createElement(core.Group, __spreadValues({
    ref: provided.innerRef,
    mt: "xs"
  }, provided.draggableProps), /* @__PURE__ */ React__default.createElement(core.Center, __spreadValues({}, provided.dragHandleProps), /* @__PURE__ */ React__default.createElement(iconsReact.IconGripVertical, {
    size: "1.2rem"
  })), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    placeholder: "John Doe"
  }, form$1.getInputProps(`employees.${index}.name`))), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    placeholder: "example@mail.com"
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    onDragEnd: ({ destination, source }) => form$1.reorderListItem("employees", { from: source.index, to: destination.index })
  }, /* @__PURE__ */ React__default.createElement(reactBeautifulDnd.Droppable, {
    droppableId: "dnd-list",
    direction: "vertical"
  }, (provided) => /* @__PURE__ */ React__default.createElement("div", __spreadProps(__spreadValues({}, provided.droppableProps), {
    ref: provided.innerRef
  }), fields, provided.placeholder))), /* @__PURE__ */ React__default.createElement(core.Group, {
    position: "center",
    mt: "md"
  }, /* @__PURE__ */ React__default.createElement(core.Button, {
    onClick: () => form$1.insertListItem("employees", { name: "", email: "" })
