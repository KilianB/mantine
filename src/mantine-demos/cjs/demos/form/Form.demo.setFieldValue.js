...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    label: "Email",
    placeholder: "Email"
  }, form$1.getInputProps("email"))), /* @__PURE__ */ React__default.createElement(core.Group, {
    position: "center",
    mt: "xl"
  }, /* @__PURE__ */ React__default.createElement(core.Button, {
    variant: "outline",
    onClick: () => form$1.setFieldValue("name", hooks.randomId())
  }, "Random name"), /* @__PURE__ */ React__default.createElement(core.Button, {
    variant: "outline",
