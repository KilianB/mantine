...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    withAsterisk: true,
    mt: "md"
  }, form$1.getInputProps("job"))), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    label: "Your email",
    placeholder: "Your email",
    withAsterisk: true,
    mt: "md"
  }, form$1.getInputProps("email"))), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    label: "Your favorite color",
    placeholder: "Your favorite color",
    withAsterisk: true,
    mt: "md"
  }, form$1.getInputProps("favoriteColor"))), /* @__PURE__ */ React__default.createElement(core.NumberInput, __spreadValues({
    label: "Your age",
    placeholder: "Your age",
    withAsterisk: true,
    mt: "md"
  }, form$1.getInputProps("age"))), /* @__PURE__ */ React__default.createElement(core.Group, {
    position: "right",
    mt: "md"
