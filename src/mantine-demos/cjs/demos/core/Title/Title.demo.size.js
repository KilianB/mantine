...
function Demo() {
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.Title, {
    order: 3,
    size: "h1"
  }, "H3 heading with h1 font-size"), /* @__PURE__ */ React__default.createElement(core.Title, {
    size: "h4"
  }, "H1 heading with h4 font-size"), /* @__PURE__ */ React__default.createElement(core.Title, {
    size: core.rem(12)
  }, "H1 heading with ", core.rem(12), " size"));
}
const size = {
  type: "demo",
  component: Demo,
