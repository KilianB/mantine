...
function Demo() {
  ...
  }, (props) => /* @__PURE__ */ React__default.createElement(core.Button, __spreadValues({}, props), "Upload image")), /* @__PURE__ */ React__default.createElement(core.Button, {
    disabled: !file,
    color: "red",
    onClick: clearFile
  }, "Reset")), file && /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "sm",
    align: "center",
    mt: "sm"
  }, "Picked file: ", file.name));
