...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.Group, {
    ...
    multiple: true
  }, (props) => /* @__PURE__ */ React__default.createElement(core.Button, __spreadValues({}, props), "Upload image"))), files.length > 0 && /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "sm",
    mt: "sm"
  }, "Picked files:"), /* @__PURE__ */ React__default.createElement(core.List, {
    size: "sm",
    mt: 5,
    withPadding: true
  }, files.map((file, index) => /* @__PURE__ */ React__default.createElement(core.List.Item, {
    key: index
  }, file.name))));
}
const multiple = {
