...
function Demo() {
  ...
  const content = Array(count).fill(0).map((_, index) => /* @__PURE__ */ React__default.createElement("p", {
    key: index
  }, lorem));
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.ScrollArea.Autosize, {
    mah: 300,
    maw: 400,
    mx: "auto"
  ...
  }, "Remove paragraph"), /* @__PURE__ */ React__default.createElement(core.Button, {
    variant: "outline",
