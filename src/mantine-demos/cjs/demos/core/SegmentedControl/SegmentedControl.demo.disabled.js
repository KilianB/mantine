...
function Demo() {
  return /* @__PURE__ */ React__default.createElement(core.Stack, {
    ...
    weight: 500,
    mb: 3
  }, "Disabled control"), /* @__PURE__ */ React__default.createElement(core.SegmentedControl, {
    disabled: true,
    data: [
      {
        value: "preview",
    ...
    weight: 500,
    mb: 3
  }, "Disabled option"), /* @__PURE__ */ React__default.createElement(core.SegmentedControl, {
    data: [
      {
        value: "preview",
        label: "Preview",
