...
function Demo() {
  return /* @__PURE__ */ React__default.createElement(core.Card, {
    ...
    weight: 500
  }, "Review pictures"), /* @__PURE__ */ React__default.createElement(core.Menu, {
    withinPortal: true,
    position: "bottom-end",
    shadow: "sm"
  }, /* @__PURE__ */ React__default.createElement(core.Menu.Target, null, /* @__PURE__ */ React__default.createElement(core.ActionIcon, null, /* @__PURE__ */ React__default.createElement(iconsReact.IconDots, {
    size: "1rem"
  }))), /* @__PURE__ */ React__default.createElement(core.Menu.Dropdown, null, /* @__PURE__ */ React__default.createElement(core.Menu.Item, {
    icon: /* @__PURE__ */ React__default.createElement(iconsReact.IconFileZip, {
      size: core.rem(14)
    })
  }, "Download zip"), /* @__PURE__ */ React__default.createElement(core.Menu.Item, {
    icon: /* @__PURE__ */ React__default.createElement(iconsReact.IconEye, {
      size: core.rem(14)
    })
  }, "Preview all"), /* @__PURE__ */ React__default.createElement(core.Menu.Item, {
    icon: /* @__PURE__ */ React__default.createElement(iconsReact.IconTrash, {
      size: core.rem(14)
    }),
    color: "red"
  }, "Delete all"))))), /* @__PURE__ */ React__default.createElement(core.Text, {
    mt: "sm",
    color: "dimmed",
    size: "sm"
  }, /* @__PURE__ */ React__default.createElement(core.Text, {
    ...
    inherit: true,
    color: "blue"
  }, "200+ images uploaded"), " ", "since last visit, review them to select which one should be added to your gallery"), /* @__PURE__ */ React__default.createElement(core.Card.Section, {
    mt: "sm"
    ...
    cols: 3
  }, images.map((image) => /* @__PURE__ */ React__default.createElement(core.Image, {
    src: image,
    key: image,
    radius: "sm"
  })))));
}
const section = __spreadProps(__spreadValues({}, _demoBase.demoBase), {
  type: "demo",
  component: Demo,
  code
});
