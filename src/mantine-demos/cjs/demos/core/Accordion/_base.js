...
const baseDemoItems = _mockdata.baseAccordionMockdata.map((item) => /* @__PURE__ */ React__default.createElement(core.Accordion.Item, {
  key: item.label,
  value: item.id
}, /* @__PURE__ */ React__default.createElement(core.Accordion.Control, null, item.label), /* @__PURE__ */ React__default.createElement(core.Accordion.Panel, null, item.content)));
