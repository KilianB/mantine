...
function Demo() {
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(core.Slider, {
    thumbChildren: /* @__PURE__ */ React__default.createElement(iconsReact.IconHeart, {
      size: "1rem",
      stroke: 1.5
    }),
    color: "red",
    ...
    thumbSize: 26,
    thumbChildren: [
      /* @__PURE__ */ React__default.createElement(iconsReact.IconHeart, {
        size: "1rem",
        stroke: 1.5,
        key: "1"
      }),
      /* @__PURE__ */ React__default.createElement(iconsReact.IconHeartBroken, {
        size: "1rem",
        stroke: 1.5,
        key: "2"
      })
