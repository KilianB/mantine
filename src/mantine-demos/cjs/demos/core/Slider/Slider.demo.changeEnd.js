...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    mt: "md",
    size: "sm"
  }, "onChange value: ", /* @__PURE__ */ React__default.createElement("b", null, value)), /* @__PURE__ */ React__default.createElement(core.Text, {
    mt: 5,
    size: "sm"
  }, "onChangeEnd value: ", /* @__PURE__ */ React__default.createElement("b", null, endValue)));
}
const changeEnd = {
  type: "demo",
  component: Demo,
