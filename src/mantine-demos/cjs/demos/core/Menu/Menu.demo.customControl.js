...
const UserButton = React.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(core.UnstyledButton, __spreadValues({
    ...
    color: "dimmed",
    size: "xs"
  }, email)), icon || /* @__PURE__ */ React__default.createElement(iconsReact.IconChevronRight, {
    size: "1rem"
  })));
});
function Demo() {
  return /* @__PURE__ */ React__default.createElement(core.Group, {
    ...
    withArrow: true
  }, /* @__PURE__ */ React__default.createElement(core.Menu.Target, null, /* @__PURE__ */ React__default.createElement(UserButton, {
    image: "https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=255&q=80",
    name: "Harriette Spoonlicker",
    email: "hspoonlicker@outlook.com"
  })), /* @__PURE__ */ React__default.createElement(_menuItems.DemoMenuItems, {
    withTarget: false
  })));
}
const customControl = {
