...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    onClick: toggle
  }, active ? "Deactivate" : "Activate", " focus trap"), /* @__PURE__ */ React__default.createElement(core.FocusTrap, {
    active
  }, /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement(core.TextInput, {
    mt: "sm",
    label: "First input",
