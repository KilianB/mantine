...
function Value(_a) {
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({}, others), /* @__PURE__ */ React__default.createElement(core.Box, {
    sx: (theme) => ({
      ...
      alignItems: "center",
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[7] : theme.white,
      border: `${core.rem(1)} solid ${theme.colorScheme === "dark" ? theme.colors.dark[7] : theme.colors.gray[4]}`,
      paddingLeft: theme.spacing.xs,
      borderRadius: theme.radius.sm
    })
    ...
    sx: { lineHeight: 1, fontSize: core.rem(12) }
...
const Item = React.forwardRef((_c, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement("div", __spreadValues({
    ref
  }, others), /* @__PURE__ */ React__default.createElement(core.Flex, {
    align: "center"
  }, /* @__PURE__ */ React__default.createElement(core.Box, {
    mr: 10
