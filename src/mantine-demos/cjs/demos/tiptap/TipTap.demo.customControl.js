...
function InsertStarControl() {
  ...
  return /* @__PURE__ */ React__default.createElement(tiptap.RichTextEditor.Control, {
    onClick: () => editor == null ? void 0 : editor.commands.insertContent("\u2B50"),
    "aria-label": "Insert star emoji",
    title: "Insert star emoji"
  }, /* @__PURE__ */ React__default.createElement(iconsReact.IconStar, {
    stroke: 1.5,
    size: "1rem"
  }));
}
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(tiptap.RichTextEditor, {
    editor
  }, /* @__PURE__ */ React__default.createElement(tiptap.RichTextEditor.Toolbar, null, /* @__PURE__ */ React__default.createElement(InsertStarControl, null)), /* @__PURE__ */ React__default.createElement(tiptap.RichTextEditor.Content, null));
}
const customControl = {
  type: "demo",
  component: Demo,
