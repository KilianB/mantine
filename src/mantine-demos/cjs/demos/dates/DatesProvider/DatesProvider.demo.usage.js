...
`;
function Demo() {
  return /* @__PURE__ */ React__default.createElement(dates.DatesProvider, {
    settings: { locale: "ru", firstDayOfWeek: 0, weekendDays: [0] }
  }, /* @__PURE__ */ React__default.createElement(dates.MonthPickerInput, {
    label: "Pick month",
    placeholder: "Pick month"
  }), /* @__PURE__ */ React__default.createElement(dates.DatePickerInput, {
    mt: "md",
    label: "Pick date",
