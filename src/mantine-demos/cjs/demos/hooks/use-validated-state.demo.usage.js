...
`;
function Demo() {
  const [{ value, lastValidValue, valid }, setEmail] = hooks.useValidatedState("", (val) => /^\S+@\S+$/.test(val), true);
  return /* @__PURE__ */ React__default.createElement(core.Box, {
    ...
    color: "dimmed",
    component: "span"
  }, "Current value:"), " ", value || "[empty string]"), /* @__PURE__ */ React__default.createElement(core.Text, {
    size: "sm"
  }, /* @__PURE__ */ React__default.createElement(core.Text, {
    inherit: true,
    color: "dimmed",
    component: "span"
  }, "Last valid value:"), " ", lastValidValue || "[empty string]"));
}
