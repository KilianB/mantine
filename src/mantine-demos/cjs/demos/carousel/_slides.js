...
function Slides({ count }) {
  const slides = Array(count).fill(0).map((_, index) => /* @__PURE__ */ React__default.createElement(carousel.Carousel.Slide, {
    key: index
  }, /* @__PURE__ */ React__default.createElement(Slide, null, index + 1)));
