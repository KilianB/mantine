...
function Demo() {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, /* @__PURE__ */ React__default.createElement(carousel.Carousel, {
    dragFree: true,
    slideSize: "50%",
    slideGap: "md",
    height: 200,
    ...
    value: scrollProgress,
    styles: { bar: { transitionDuration: "0ms" }, root: { maxWidth: core.rem(320) } },
    size: "sm",
    mt: "xl",
    mx: "auto"
  }));
