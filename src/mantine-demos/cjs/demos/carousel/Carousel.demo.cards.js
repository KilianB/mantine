...
function CarouselCardsDemos(props) {
  ...
  const slides = data.map((item) => /* @__PURE__ */ React__default.createElement(carousel.Carousel.Slide, {
    key: item.title
  }, /* @__PURE__ */ React__default.createElement(_card.Card, __spreadValues({}, item))));
  return /* @__PURE__ */ React__default.createElement(carousel.Carousel, __spreadValues({
    slideSize: "50%",
    breakpoints: [{ maxWidth: "sm", slideSize: "100%", slideGap: 2 }],
    slideGap: "xl",
    align: "start",
