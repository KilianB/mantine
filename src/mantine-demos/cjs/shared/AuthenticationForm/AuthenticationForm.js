...
function AuthenticationForm({
  ...
  return /* @__PURE__ */ React__default.createElement(core.Paper, {
    ...
    label: "First name"
  }, form$1.getInputProps("firstName"))), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    required: true,
    placeholder: "Your last name",
    label: "Last name"
  }, form$1.getInputProps("lastName")))), /* @__PURE__ */ React__default.createElement(core.TextInput, __spreadValues({
    mt: "md",
    required: true,
  ...
  }, form$1.getInputProps("email"))), /* @__PURE__ */ React__default.createElement(core.PasswordInput, __spreadValues({
    mt: "md",
    required: true,
  ...
  }, form$1.getInputProps("password"))), formType === "register" && /* @__PURE__ */ React__default.createElement(core.PasswordInput, __spreadValues({
    mt: "md",
    required: true,
  ...
  }, form$1.getInputProps("confirmPassword"))), formType === "register" && /* @__PURE__ */ React__default.createElement(core.Checkbox, __spreadValues({
    mt: "xl",
    label: "I agree to sell my soul and privacy to this corporation"
  }, form$1.getInputProps("termsOfService", { type: "checkbox" }))), error && /* @__PURE__ */ React__default.createElement(core.Text, {
    color: "red",
    size: "sm",
    mt: "sm"
