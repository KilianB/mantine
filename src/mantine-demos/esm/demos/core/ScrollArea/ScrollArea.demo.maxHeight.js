...
function Demo() {
  const [count, handlers] = useCounter(3, { min: 0, max: 10 });
  const content = Array(count).fill(0).map((_, index) => /* @__PURE__ */ React.createElement("p", {
    key: index
  }, lorem));
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(ScrollArea.Autosize, {
    mah: 300,
    maw: 400,
    mx: "auto"
  ...
  }, "Remove paragraph"), /* @__PURE__ */ React.createElement(Button, {
    variant: "outline",
