...
function Demo() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Title, {
    order: 3,
    size: "h1"
  }, "H3 heading with h1 font-size"), /* @__PURE__ */ React.createElement(Title, {
    size: "h4"
  }, "H1 heading with h4 font-size"), /* @__PURE__ */ React.createElement(Title, {
    size: rem(12)
  }, "H1 heading with ", rem(12), " size"));
}
const size = {
  type: "demo",
  component: Demo,
