...
import { Box, Popover, PasswordInput, Progress, Text } from '@mantine/core';
...
function PasswordRequirement({ meets, label }) {
  return /* @__PURE__ */ React.createElement(Text, {
    ...
    mt: 7,
    size: "sm"
  }, meets ? /* @__PURE__ */ React.createElement(IconCheck, {
    size: "0.9rem"
...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(Box, {
    ...
    value,
    onChange: (event) => setValue(event.currentTarget.value)
  }))), /* @__PURE__ */ React.createElement(Popover.Dropdown, null, /* @__PURE__ */ React.createElement(Progress, {
    color,
    value: strength,
    size: 5,
    mb: "xs"
