...
import { Group, MANTINE_COLORS, ActionIcon, rem } from '@mantine/core';
...
const getColors = (props) => MANTINE_COLORS.slice(1).map((color) => /* @__PURE__ */ React.createElement(ActionIcon, __spreadValues({
  key: color,
  color
}, props), /* @__PURE__ */ React.createElement(IconSun, {
  size: rem(18)
})));
function Demo() {
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Group, {
    position: "center"
  }, getColors({ variant: "subtle" })), /* @__PURE__ */ React.createElement(Group, {
    position: "center",
    mt: "md"
...
export { colors };
//# sourceMappingURL=ActionIcon.demo.colors.js.map
