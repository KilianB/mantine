...
function Demo() {
  ...
  }, (props) => /* @__PURE__ */ React.createElement(Button, __spreadValues({}, props), "Upload image")), /* @__PURE__ */ React.createElement(Button, {
    disabled: !file,
    color: "red",
    onClick: clearFile
  }, "Reset")), file && /* @__PURE__ */ React.createElement(Text, {
    size: "sm",
    align: "center",
    mt: "sm"
  }, "Picked file: ", file.name));
