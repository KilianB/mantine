...
import { createStyles, rem, UnstyledButton, Group, Center, Image, Text, Badge } from '@mantine/core';
...
function CustomAction(_a) {
  ...
  return /* @__PURE__ */ React.createElement(UnstyledButton, __spreadValues({
    ...
    noWrap: true
  }, action.image && /* @__PURE__ */ React.createElement(Center, null, /* @__PURE__ */ React.createElement(Image, {
    src: action.image,
    alt: action.title,
    width: 50,
    height: 50
    ...
    style: { flex: 1 }
  }, /* @__PURE__ */ React.createElement(Text, null, action.title), action.description && /* @__PURE__ */ React.createElement(Text, {
    color: "dimmed",
    size: "xs"
  }, action.description)), action.new && /* @__PURE__ */ React.createElement(Badge, null, "new")));
}
function Demo() {
