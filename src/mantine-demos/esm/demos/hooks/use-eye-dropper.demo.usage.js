...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(Group, null, /* @__PURE__ */ React.createElement(ActionIcon, {
    variant: "default",
    onClick: pickColor
  }, /* @__PURE__ */ React.createElement(IconColorPicker, {
    size: "1rem",
    stroke: 1.5
  })), color ? /* @__PURE__ */ React.createElement(Group, {
    spacing: "xs"
  }, /* @__PURE__ */ React.createElement(ColorSwatch, {
    color
  }), /* @__PURE__ */ React.createElement(Text, null, "Picked color: ", color)) : /* @__PURE__ */ React.createElement(Text, null, "Click the button to pick color"), error && /* @__PURE__ */ React.createElement(Text, {
    color: "red"
