...
function InsertStarControl() {
  const { editor } = useRichTextEditorContext();
  return /* @__PURE__ */ React.createElement(RichTextEditor.Control, {
...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(RichTextEditor, {
    editor
  }, /* @__PURE__ */ React.createElement(RichTextEditor.Toolbar, null, /* @__PURE__ */ React.createElement(InsertStarControl, null)), /* @__PURE__ */ React.createElement(RichTextEditor.Content, null));
}
const customControl = {
  type: "demo",
  component: Demo,
