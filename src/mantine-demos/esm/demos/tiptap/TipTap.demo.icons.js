...
`;
const BoldIcon = () => /* @__PURE__ */ React.createElement(IconBold, {
  size: "1rem",
  stroke: 3.5
});
const ItalicIcon = () => /* @__PURE__ */ React.createElement(IconItalic, {
  size: "1rem",
  stroke: 3.5
});
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(RichTextEditor, {
    editor
  }, /* @__PURE__ */ React.createElement(RichTextEditor.Toolbar, null, /* @__PURE__ */ React.createElement(RichTextEditor.ControlsGroup, null, /* @__PURE__ */ React.createElement(RichTextEditor.Bold, {
    icon: BoldIcon
  }), /* @__PURE__ */ React.createElement(RichTextEditor.Italic, {
    icon: ItalicIcon
