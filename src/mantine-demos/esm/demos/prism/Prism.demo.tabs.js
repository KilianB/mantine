...
import { css, py } from './Prism.demo.languages.js';
import { demoCode } from './Prism.demo.usage.js';
...
function Demo() {
  ...
  }, "styles.css"), /* @__PURE__ */ React.createElement(Prism.Tab, {
    value: "decorator.py",
    icon: /* @__PURE__ */ React.createElement(PythonIcon, {
      width: "1rem",
      height: "1rem"
    })
  }, "decorator.py"), /* @__PURE__ */ React.createElement(Prism.Tab, {
    value: "component.tsx",
    icon: /* @__PURE__ */ React.createElement(TsIcon, {
      width: "1rem",
      height: "1rem"
    })
  }, "component.tsx")), /* @__PURE__ */ React.createElement(Prism.Panel, {
    language: "css",
    value: "styles.css"
