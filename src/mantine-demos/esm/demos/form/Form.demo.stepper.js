...
function Demo() {
  ...
  }, form.getInputProps("username"))), /* @__PURE__ */ React.createElement(PasswordInput, __spreadValues({
    mt: "md",
    label: "Password",
    placeholder: "Password"
  }, form.getInputProps("password")))), /* @__PURE__ */ React.createElement(Stepper.Step, {
    label: "Second step",
    description: "Personal information"
  }, /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    label: "Name",
    placeholder: "Name"
  }, form.getInputProps("name"))), /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    mt: "md",
    label: "Email",
    placeholder: "Email"
  }, form.getInputProps("email")))), /* @__PURE__ */ React.createElement(Stepper.Step, {
    label: "Final step",
    description: "Social media"
  }, /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    label: "Website",
    placeholder: "Website"
  }, form.getInputProps("website"))), /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    mt: "md",
    label: "GitHub",
    placeholder: "GitHub"
  }, form.getInputProps("github")))), /* @__PURE__ */ React.createElement(Stepper.Completed, null, "Completed! Form values:", /* @__PURE__ */ React.createElement(Code, {
    block: true,
    mt: "xl"
  }, JSON.stringify(form.values, null, 2)))), /* @__PURE__ */ React.createElement(Group, {
    position: "right",
    mt: "xl"
  }, active !== 0 && /* @__PURE__ */ React.createElement(Button, {
    variant: "default",
    onClick: prevStep
  }, "Back"), active !== 3 && /* @__PURE__ */ React.createElement(Button, {
    onClick: nextStep
  }, "Next step")));
}
const stepper = {
