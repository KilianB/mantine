...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(Box, {
    maw: 400,
    mx: "auto"
  }, /* @__PURE__ */ React.createElement(TextInput, __spreadProps(__spreadValues({}, form.getInputProps("text")), {
    label: "Touched/dirty demo",
    placeholder: "Touched/dirty demo"
  })), /* @__PURE__ */ React.createElement(Text, {
    size: "sm",
    mt: "sm"
  }, "Touched:", " ", /* @__PURE__ */ React.createElement(Text, {
    span: true,
    color: form.isTouched("text") ? "blue" : "red"
  }, form.isTouched("text") ? "touched" : "not touched")), /* @__PURE__ */ React.createElement(Text, {
    size: "sm"
  }, "Dirty:", " ", /* @__PURE__ */ React.createElement(Text, {
    span: true,
    color: form.isDirty("text") ? "blue" : "red"
  }, form.isDirty("text") ? "dirty" : "not dirty")));
}
const status = {
  type: "demo",
