...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(Box, {
    ...
    withAsterisk: true,
    mt: "md"
  }, form.getInputProps("job"))), /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    label: "Your email",
    placeholder: "Your email",
    withAsterisk: true,
    mt: "md"
  }, form.getInputProps("email"))), /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    label: "Your favorite color",
    placeholder: "Your favorite color",
    withAsterisk: true,
    mt: "md"
  }, form.getInputProps("favoriteColor"))), /* @__PURE__ */ React.createElement(NumberInput, __spreadValues({
    label: "Your age",
    placeholder: "Your age",
    withAsterisk: true,
    mt: "md"
  }, form.getInputProps("age"))), /* @__PURE__ */ React.createElement(Group, {
    position: "right",
    mt: "md"
