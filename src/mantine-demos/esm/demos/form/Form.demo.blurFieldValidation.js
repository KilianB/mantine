...
function Demo() {
  ...
  return /* @__PURE__ */ React.createElement(Box, {
    ...
    label: "Email",
    placeholder: "Email"
  }, form.getInputProps("email"))), /* @__PURE__ */ React.createElement(NumberInput, __spreadValues({
    mt: "sm",
    label: "Age",
    placeholder: "Age",
    min: 0,
    max: 99
  }, form.getInputProps("age"))), /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    mt: "sm",
    label: "Job 1",
    placeholder: "Job 1"
  }, form.getInputProps("jobs.0.title"))), /* @__PURE__ */ React.createElement(TextInput, __spreadValues({
    mt: "sm",
    label: "Job 2",
    placeholder: "Job 2"
  }, form.getInputProps("jobs.1.title"))), /* @__PURE__ */ React.createElement(Button, {
    type: "submit",
    mt: "sm"
  }, "Submit")));
}
