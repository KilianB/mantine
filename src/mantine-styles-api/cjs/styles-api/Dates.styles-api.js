...
const YearPickerInput = __spreadValues(__spreadValues({}, TextInput_stylesApi.TextInput), YearPicker);
const MonthPickerInput = __spreadValues(__spreadValues({}, TextInput_stylesApi.TextInput), MonthPicker);
const DatePickerInput = __spreadValues(__spreadValues({}, TextInput_stylesApi.TextInput), DatePicker);
const DateInput = __spreadValues(__spreadValues({}, TextInput_stylesApi.TextInput), DatePicker);
const DateTimePicker = __spreadProps(__spreadValues(__spreadValues({}, TextInput_stylesApi.TextInput), DatePicker), {
  placeholder: "Placeholder element",
  timeWrapper: "Wrapper around time input and submit button",
  timeInput: "TimeInput"
});
const TimeInput = TextInput_stylesApi.TextInput;
